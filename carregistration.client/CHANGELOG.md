...
- Create Angular project with ng: `ng new carregistration.client --defaults --skip-install --skip-git `.
...
- Update `app.component.ts` component to fetch and display car information.
- Modify `app.component.spec.ts` with updated tests.
- Update `app.module.ts` to import the HttpClientModule.
- Create project file (`carregistration.client.esproj`).
